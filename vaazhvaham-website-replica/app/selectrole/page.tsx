...
export default function SelectRolePage() {
  ...
  // CLEAR SESSION WHEN THIS PAGE LOADS
  // This prevents users from using browser forward button to access dashboards
  useEffect(() => {
    // Clear all session data when selectrole page is loaded
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background to-muted/30 px-4 py-12 relative" suppressHydrationWarning>
      ...
      <Card className="w-full max-w-md p-8 space-y-8 shadow-xl">
        ...
        {/* Error Message */}
        {error && (
          <div className="p-4 rounded-lg border border-red-300 text-red-800 text-sm">
            {error}
          </div>
        )}
